    ...
    .then((books) => {
      ...
      if (book) {
        ...
        document.getElementById("book-pages").innerText =
          "Số trang: " + (book.totalPages || 0);
        document.getElementById("book-type").innerText =
          "Loại sách: " + book.type;
        ...
        document.getElementById("book-cover-container").innerHTML =
          `<img src="${book.coverImage}" class="w-full aspect-[2/3] object-cover shadow-md rounded">`;
        ...
        if (btnRead) {
          btnRead.onclick = () => {
            if (book.fileUrl) {
              ...
              document.getElementById("read-modal-title").innerText =
                "Đọc thử: " + book.title;
